...
* goal = Reference(Goal/scen1GoalV2)
* insert Note(2023-05-05, scen1RolePatel, "Dr. Rajesh Patel", [[Jorin is adhering well and indicates he's motivated by increased energy playing with his children.]])
...
* insert Note(2023-11-01, scen1RolePatel, "Dr. Rajesh Patel", [[Significant progress.  Regularly exceeding the target and has found an activity he enjoys.  Need to branch out to one more activity to achieve guideline target.]])
